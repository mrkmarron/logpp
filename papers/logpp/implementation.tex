...
JavaScript application. \todo{continue here}
...
conditional logging, begin/end interval, child logging, shared loggers
...
Logging aware dead-code eliminaiton

Fast string + property handling

IO load aware emitting
