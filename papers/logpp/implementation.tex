...
As seen in \autoref{fig:arch} and the example code in \autoref{fig:runningExample}, there be many loggers 
...
This code represents the transition from the formats and logger call arguments 
