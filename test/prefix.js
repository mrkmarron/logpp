...
const prefixtests = [
    ...
    { name: "prefix.child", action: () => { const childlog = logpp.childLogger({ cl: true }); childlog.info(childlog.$Hello); }, oktest: (msg) => msg.startsWith("INFO#$default @ ") && msg.endsWith(os.hostname() + "::prefix.child | {\"cl\":true} -- Hello World!!!") }
];
